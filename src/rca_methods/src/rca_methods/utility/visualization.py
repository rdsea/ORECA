...
from rca_methods.classes.graph import MemoryGraph
from rca_methods.io.time_series import drop_time
...
def draw_adj(
    adj, node_names=None, filename=None, service=None, metric=None, figsize=None
):
...
def draw_mem_graph(
    mem_graph: MemoryGraph, filename=None, service=None, metric=None, figsize=None
):
    node_names = []
