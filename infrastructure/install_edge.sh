...
helm install prometheus prometheus-community/kube-prometheus-stack \
  -n observe --values "$HELM_CHART_DIR/prometheus/values_edge.yaml" --create-namespace --version 75.12.0
...
helm install my-opentelemetry-collector open-telemetry/opentelemetry-collector \
  -f "$HELM_CHART_DIR/otel/values_edge.yaml" -n observe --version 0.129.0
